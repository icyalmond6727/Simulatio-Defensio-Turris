...
def get_tile_center(x, y, tile_size):
    ...
    Returns:
        tuple: The (center_x, center_y) coordinates in pixels.
    """
...
def get_interception(tower, enemy):
    ...
    Returns:
        tuple or None: The (hit_x, hit_y, frames_to_hit) if an interception point is found, else None.
    """
    t0 = 0
